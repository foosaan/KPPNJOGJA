...
class StaffController extends Controller
{
    ...
    public function berkasProses()
    {
        ...
        return view('staff.berkasproses', compact('allRequests'));
    }
    ...
    public function berkasSelesai()
    {
        ...
        return view('staff.berkasselesai', compact('allRequests'));
    }
    ...
    public function berkasDitolak()
    {
        ...
        return view('staff.berkasditolak', compact('allRequests'));
    }
